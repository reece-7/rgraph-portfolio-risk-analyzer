...
def render_rebalancing(results):
    ...
    render_chart_heading(
        ...
        title="Portfolio value lost to trading costs",
        description=(
    ...
    cost_drag_heatmap = build_rebalancing_heatmap(
    ...
    render_chart_heading(
        ...
        title="Cumulative trading costs paid",
        description=(
            "Total transaction costs generated by each "
            "strategy under every modeled cost assumption."
        ),
    )

    total_cost_heatmap = build_rebalancing_heatmap(
        transaction_cost_summary=transaction_cost_summary,
